...
# kernel
git clone https://github.com/orlan-kecap/Daendless-Road.git -b A16 kernel/xiaomi/sm6150

# miui camera
git clone https://github.com/orlan-kecap/vendor_xiaomi_miuicamera-sweet.git -b 16.2 vendor/xiaomi/miuicamera-sweet
git clone https://github.com/orlan-kecap/device_xiaomi_miuicamera-sweet.git -b 16.2 device/xiaomi/miuicamera-sweet
